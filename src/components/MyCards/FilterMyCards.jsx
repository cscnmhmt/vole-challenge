...
const FilterMyCards = ({ cardTypesMyCards, cardPositionsMyCards }) => {
      ...
      <div className="flex min-w-[200px] flex-col rounded-base bg-sky-white px-6 py-2">
        ...
        >
          <AccordionItem className="border-b border-sky-light py-4">
            ...
            <AccordionItemPanel>
              <ul className="mt-4">
                {Array.isArray(cardTypesMyCards)
                  ? cardTypesMyCards.map((card, index) => (
                      <li key={index}>
                        <input
                          type="checkbox"
                          name={card}
          ...
          <AccordionItem className="border-b border-sky-light py-4">
            ...
            <AccordionItemPanel>
              <ul className="mt-4">
                {Array.isArray(cardPositionsMyCards)
                  ? cardPositionsMyCards.map((position, index) => (
                      <li key={index}>
                        <input
                          type="checkbox"
                          name={position}
